void Propotional_derivative() {
  ...
  int error = f_panel[0] * 0+ f_panel[1] * 0 + f_panel[2] * 0 + f_panel[3] * 0 + f_panel[4] * 70 + f_panel[5] * 50 + f_panel[6] * 40 + f_panel[7] * 30 +f_panel[8] * -30 + f_panel[9] * -40 + f_panel[10] * -50 + f_panel[11] * -70 + f_panel[12] *-0 + f_panel[13] * -0 + f_panel[14] * -0 + f_panel[15] * -0;
  double deri = 60
  * (error - Last_Error);
